...
def run_security_system():
    ...
    try:
        subprocess.Popen(["python3", "security_system_v2.py"])
    except Exception as e:
...
btn_security = tk.Button(root, text="3. Start Live Security Feed", font=("Helvetica", 12), bg="#e74c3c", fg="black", width=25, height=2, command=run_security_system)
...
def on_closing():
    ...
    try:
        ...
        print("Subprocesses could not be killed automatically.", e)
    finally:
        root.destroy()
